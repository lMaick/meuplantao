...
export type Payment = { id:string; user_id:string; obligation_id:string; valor:number; data_pagamento:string; status:PaymentStatus; created_at:string; updated_at:string };
export type PaymentInput = Pick<Payment,"obligation_id"|"valor"|"data_pagamento"> & { status?: PaymentStatus };
